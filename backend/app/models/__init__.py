...
class Tag(Base):
    ...
    color = Column(String(50), default='#10B981') # green, blue, purple, amber, rose etc.
    created_at = Column(DateTime, default=datetime.utcnow)
...
class Message(Base):
    ...
    external_id = Column(String(255), nullable=True) # WhatsApp Message ID
    created_at = Column(DateTime, default=datetime.utcnow)
...
class Notification(Base):
    ...
    notification_type = Column(String(50), default='general') # message, customer, followup, sale, task
